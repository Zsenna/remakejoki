    ...
    <div class="card-group" style="margin: 2em;">
        <div class="card bg-primary product" style="margin: 1em;">
            <a href="Product-7.html">
                <img class="card-img-top" src="../img/bannerslider-sp2020-1800x600-fix444x250-webp.png" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title" style="color: white;">Nama Product</h5>
                    <p class="card-text" style="color: white;">Deskripsi singkat...</p>
                </div>
            </a>
        </div>
        <div class="card bg-primary product" style="margin: 1em;">
