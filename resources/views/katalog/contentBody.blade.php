...
<body>
    ...
    <h1 class="headline-text">Company Profile</h1>
    ...
    $workshop =
        DB::select('SELECT itemImg, itemText, itemDesc, headImg, mainbox_id FROM mainbox WHERE itemTo = "workshop"');
    ?>
    <div id="homecon" class="container-fluid">
        <div class="container-fluid-1">
            <img src="img\picture-electric-automation-seamless-connectivity-screen-fix18.png" class="img-fluid" alt="" style="filter: brightness(50%);">
        </div>
    </div>
    ...
    <div class="container highlight-content">
        <div class="row justify-content-md-center">
            ...
            <a href="#" class="col highlight-content-2" style="text-decoration: none; color: black">
                <p><img alt="" src="{{$work->itemImg}}" style="float:left; height:50%; margin:10px; width:50%" /></p>
