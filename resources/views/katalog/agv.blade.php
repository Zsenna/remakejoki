...
<body>
    ...
    <div class="card-group" style="margin: 2em;">
        <div class="card bg-primary product" style="margin: 1em;">
            <a href="{{url('Product-agv/' .$a->id)}}">
                <img class="card-img-top" src="{{$a->itemImg}}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title" style="color: white;">{{$a->itemText}}</h5>
                    <p class="card-text" style="color: white;">{{Strip_tags($a->itemDesc)}}</p>
                </div>
            </a>
        </div>
    </div>
