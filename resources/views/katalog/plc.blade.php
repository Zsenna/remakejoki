...
<body>
    ...
    <div class="card-group" style="margin: 2em;">
        <div class="card bg-primary product" style="margin: 1em;">
            <a href="{{url('Product-plc/' .$p->id)}}">
                <img class="card-img-top" src="{{$p->itemImg}}" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title" style="color: white;">{{$p->itemText}}</h5>
                    <p class="card-text" style="color: white;">{{Strip_tags($p->itemDesc)}}</p>
                </div>
            </a>
        </div>
    </div>
