...
<body>
    ...
    $highlight = DB::select('SELECT headImg, itemImg, itemText, itemDesc, mainbox_id FROM mainbox WHERE itemTo = "highl"');
    ?>
        ...
        <div id="carouselExampleCaptions" class="carousel carousel-dark slide" data-bs-ride="carousel">
            <div class="container-fluid-1">
                ...
                <div class="carousel-inner">
                    ...
                    @foreach($highlight as $highl)
                    <div class="carousel-item">
                        <img src="{{$highl->headImg}}" class="img-fluid" alt="">
                        <div class="container-fluid">
                            <div class="container-fluid-top">
                                <h4>{{ $highl->itemText}}</h4>
                                <p>{{ strip_tags($highl->itemDesc)}}</p>
                            </div>
                        </div>
                        <!-- <div class="container-fluid-bot">
                                <a class="btn btn-primary" href="#" role="button">Find Out More</a>
