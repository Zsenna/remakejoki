...
<body">
    ...
    <div class="container-lg px-2">
        <div data-aos="fade-down" data-aos-duration="1000" data-aos-easing="ease-in-sine">
            <div class="row">
                <div id="tittle" class="container">
                    <div class="col-lg">
                        <div class="fw-bolder">Schedule<a style="color: #0091DC;">/</a>e an appointment</div>
                    </div>
                </div>
        ...
        <div data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-sine">
            <div id="alamat" class="container-lg">
                <div class="row pt-4">
                    <div class="col-lg-3">
                        <div class="fs-1">
                            <p style="color: #0091DC;">Address</p>
                        </div>
                        <div class="fs-4">
                    ...
                    <div class="col-lg-6">
                        <div class="fs-1">
                            <p style="color: #0091DC;">Social Media</p>
                        </div>
                        <div class="row fs-4">
                            <div class="row fs-4">
                                <div class="col-lg-4 ">
        ...
        <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2500">
            <div class="row">
                <div class="col-12 py-5">
                    <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.258207388961!2d106.82465937483761!3d-6.360617562223779!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec1a804e8b85%3A0xd7bf80e1977cea07!2sUniversitas%20Indonesia!5e0!3m2!1sen!2sid!4v1694064434699!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
